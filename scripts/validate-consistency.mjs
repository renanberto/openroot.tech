...
const checks = [
  ...
  ["main", "apps/renanberto/src/main.ts", ["OS Release 1", "renderInspectorPanel", "data-panel-view", "terminalApi?.focus"]],
...
console.log("OpenRoot OS Release 1 consistency validation passed.");
